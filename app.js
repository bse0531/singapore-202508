...
(function(){
  ...
  function openAt(i0){
    ...
    frame.style.cssText='display:flex;gap:10px;align-items:center;';
    const img=document.createElement('img');
    img.style.cssText='max-width:90vw;max-height:70vh;border-radius:12px;';
    const prev=document.createElement('button'); prev.textContent='‹'; prev.className='arrow-btn';
    const next=document.createElement('button'); next.textContent='›'; next.className='arrow-btn';
    ...
    const close=document.createElement('button'); close.textContent='Close'; close.className='arrow-btn';
